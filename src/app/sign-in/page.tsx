...
const Page = () => {
    ...
    async function handleSubmit(event: FormEvent) {
        ...
        try {
            await axios.post(`${clientEnv.apiUrl}/api/v1/auth/magic-link?provider=email`, { email });
                ...
                <form action="" className='w-full flex flex-col gap-4' onSubmit={handleSubmit}>
                    <label className='flex flex-col gap-1 w-full font-sans text-sm font-medium'>
                        ...
                        <svg className='absolute left-3' width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path className='stroke-[#2e2e2e]' d="M2.5 2.5H12.5C13.1875 2.5 13.75 3.0625 13.75 3.75V11.25C13.75 11.9375 13.1875 12.5 12.5 12.5H2.5C1.8125 12.5 1.25 11.9375 1.25 11.25V3.75C1.25 3.0625 1.8125 2.5 2.5 2.5Z" strokeLinecap="round" strokeLinejoin="round"/>
                            <path className='stroke-[#2e2e2e]' d="M13.75 3.75L7.5 8.125L1.25 3.75"  strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                        <input
                            type="email"
                            name="email"
